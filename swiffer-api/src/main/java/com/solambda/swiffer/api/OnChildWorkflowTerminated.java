...
/**
 * Handler for the {@link EventType#ChildWorkflowExecutionTerminated} event.
 * <p>
...
@Target(METHOD)
@EventHandler
public @interface OnChildWorkflowTerminated {

    /**
     * The child {@link WorkflowType} that was terminated.
     *
     * @return the terminated workflow type
     */
    Class<?> value();
}
