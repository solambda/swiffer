...
public class ArgumentProviders {
	...
	public static final Function<EventContext, String> CONTROL_PROVIDER = c -> c.event().control();
	public static final Function<EventContext, Object> DETAILS_PROVIDER = c -> c.event().details();
	public static final Function<EventContext, String> INPUT_PROVIDER = c -> c.event().input();
	public static final Function<EventContext, Object> MARKER_NAME_PROVIDER = c -> c.event().markerName();
	public static final Function<EventContext, String> OUTPUT_PROVIDER = c -> c.event().output();
	...
	public static final Function<EventContext, Object> CHILD_RUN_ID_PROVIDER = c -> c.event().childWorkflowRunId();
