...
/**
 * Mark a method as an activity method that can handle a registered SWF Activity
 * Task. Methods annotated with <code>ActivityMethod</code> must have the
 * following signature:
 *
 * <pre>
 * <code>
 ...
 * </pre>
 * <p/>
 * If the return type is void or the method returns null an empty string will be
 * recorded as the activity task result. Otherwise the result will be recorded
 * as the return value converted to a string using toString().
 * <p/>
 * Activities that throw exceptions will be recorded as an error on their
 * related workflow.
 *
 * @see RegisterActivityTypeRequest RegisterActivityTypeRequest for details and
...
public @interface Task {
	...
	/**
	 * Task priority values can range from "-2147483648" to "2147483647", with
	 * higher numbers indicating higher priority. If you don't set the task
	 * priority for an activity or workflow, it will be assigned a priority of
	 * zero ("0").
	 *
