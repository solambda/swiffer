...
public class TestEventDelegatorDeciderIsNotified {
	...
	//
	// private WorkflowStartedHandler workflowfStartedHandler =
	// mock(WorkflowStartedHandler.class);
	// private WorkflowTerminatedHandler workflowfTerminatedHandler =
	// mock(WorkflowTerminatedHandler.class);
	// private WorkflowCancelRequestedHandler workflowfCancelRequestedHandler =
	// mock(WorkflowCancelRequestedHandler.class);
	// private SignalReceivedHandler signalReceivedHandler =
	// mock(SignalReceivedHandler.class);
	// private TaskCompletedHandler taskCompletedHandler =
	// mock(TaskCompletedHandler.class);
	// private TaskTimedOutHandler taskTimedOutHandler =
	// mock(TaskTimedOutHandler.class);
	// private TaskFailedHandler taskFailedHandler =
	// mock(TaskFailedHandler.class);
	// private TaskScheduleFailedHandler taskScheduleFailedHandler =
	// mock(TaskScheduleFailedHandler.class);
	// private TimerFiredHandler timerFiredHandler =
	// mock(TimerFiredHandler.class);
	// private TimerCanceledHandler timerCanceledHandler =
	// mock(TimerCanceledHandler.class);
	// private MarkerRecordedHandler markerRecorderHandler =
	// mock(MarkerRecordedHandler.class);
	//
	// public TestEventDelegatorDeciderIsNotified() {
	// final EventContextHandlerRegistryBuilder registryBuilder = new
	// EventContextHandlerRegistryBuilder(
	...
	// final ContextProvider<DecisionTaskContext> provider = new
	// DecisionTaskPoller(ObjectMother.client(),
	...
	// reset(this.workflowfStartedHandler, this.workflowfCancelRequestedHandler,
	// this.workflowfTerminatedHandler,
	// this.taskCompletedHandler, this.taskFailedHandler,
	// this.taskScheduleFailedHandler,
	...
	// // THEN
	// final ArgumentCaptor<WorkflowStartedContext> captor =
	// ArgumentCaptor.forClass(WorkflowStartedContext.class);
	// verify(this.workflowfStartedHandler).onWorkflowStarted(captor.capture(),
	// any());
	...
	// this.consumer.consume();
	// // THEN
	// final ArgumentCaptor<SignalReceivedContext> captor =
	// ArgumentCaptor.forClass(SignalReceivedContext.class);
	// verify(this.signalReceivedHandler).onSignalReceived(captor.capture(),
	// any());
	...
	//
	// // THEN
	// final ArgumentCaptor<WorkflowCancelRequestedContext> captor =
	// ArgumentCaptor
	// .forClass(WorkflowCancelRequestedContext.class);
	// verify(this.workflowfCancelRequestedHandler).onWorkflowCancelRequested(captor.capture(),
	// any());
	...
	// this.consumer.consume();
	// // THEN
	// final ArgumentCaptor<ActivityTaskCompletedContext> captor =
	// ArgumentCaptor.forClass(ActivityTaskCompletedContext.class);
	// verify(this.taskCompletedHandler).onTaskCompleted(captor.capture(),
	// any());
	// assertThat(captor.getValue().output()).isEqualTo(output);
	// assertThat(captor.getValue().activityType()).isEqualTo(ObjectMother.taskType());
	// }
	//
	// @Test
	...
	// this.consumer.consume();
	// // THEN
	// final ArgumentCaptor<ActivityTaskFailedContext> captor =
	// ArgumentCaptor.forClass(ActivityTaskFailedContext.class);
	...
	// this.consumer.consume();
	// // THEN
	// final ArgumentCaptor<ActivityTaskTimedOutContext> captor =
	// ArgumentCaptor.forClass(ActivityTaskTimedOutContext.class);
	...
	// assertThat(captor.getValue().activityType()).isEqualTo(ObjectMother.smallTimeoutTaskType());
	// }
	//
	// @Test
	...
	// to.scheduleTask(ObjectMother.unregisteredTaskType()))
	// .when(this.workflowfStartedHandler).onWorkflowStarted(any(), any());
	// this.consumer.consume();
	// this.consumer.consume();
	//
	// // THEN
	// final ArgumentCaptor<ActivityTaskScheduleFailedContext> captor =
	// ArgumentCaptor
	// .forClass(ActivityTaskScheduleFailedContext.class);
	// verify(this.taskScheduleFailedHandler).onTaskScheduleFailed(captor.capture(),
	// any());
	// assertThat(captor.getValue().cause()).isEqualTo("ACTIVITY_TYPE_DOES_NOT_EXIST");
	// assertThat(captor.getValue().activityId()).isNotNull();
	// assertThat(captor.getValue().activityType()).isEqualTo(ObjectMother.unregisteredTaskType());
	//
	// }
	//
	// @Test
	...
	// this.workflow.start();
	// ObjectMother.makeDecider(to ->
	// to.completeWorfklow()).when(this.workflowfStartedHandler).onWorkflowStarted(
	// any(),
	// any());
	// this.consumer.consume();
	//
	...
	// this.workflow.start();
	// this.workflow.terminate(Failure.reason(reasonSent).details(detailsSent),
	...
	// this.consumer.consume();
	// // THEN
	// final ArgumentCaptor<TimerFiredContext> captor =
	// ArgumentCaptor.forClass(TimerFiredContext.class);
	...
	// ObjectMother.makeDecider(to -> {
	// to.startTimer(ObjectMother.timerName().name(), input,
	...
	// // THEN
	// final ArgumentCaptor<TimerCanceledContext> captor =
	// ArgumentCaptor.forClass(TimerCanceledContext.class);
	// verify(this.timerCanceledHandler).onTimerCanceled(captor.capture(),
	// any());
	...
	// this.consumer.consume();
	// // THEN
	// final ArgumentCaptor<MarkerRecordedContext> captor =
	// ArgumentCaptor.forClass(MarkerRecordedContext.class);
	// verify(this.markerRecorderHandler).onMarkerRecorded(captor.capture(),
	// any());
	...
	// }
	//
	// private void startTimer(final String timerName, final String input, final
	// int timeoutInSeconds) {
	// ObjectMother.makeDecider(to -> to.startTimer(timerName, input,
