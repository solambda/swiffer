...
public class WorkflowTest {
	...
	public static class ATimedOutWorkflow {
		private static WorkflowBuilder builder = new WorkflowBuilder()
				...
				.id("timed-out");
		private static Workflow workflow = builder.ensureRegistered().build();
	...
	private static void invokeDecider(final Decider decider) {
		DecisionContextProviderImpl provider = new DecisionContextProviderImpl(ObjectMother.client(), ObjectMother.domainName(), null,
				WorkflowTest.class.getName());
		WorkflowConsumerTest iterator = new WorkflowConsumerTest(decider, provider);
		iterator.consume();
	}
